...
from sqlalchemy.orm.exc import FlushError  # Add this import
...
class RecipeIndex(Resource):
    ...
    def post(self):
        ...
        # Add validation for instructions length
        ...
        except (IntegrityError, FlushError, ValueError):  # Catch additional exceptions
            db.session.rollback()
            return {'error': '422 Unprocessable Entity'}, 422
